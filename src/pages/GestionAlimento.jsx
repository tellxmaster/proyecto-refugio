...
const GestionAlimento = () => {
    ...
    const eliminarProducto = (productId) => {
        // Asumiendo que tienes un endpoint para eliminar productos por ID.
    ...
    return (
        <>
            <div className="container h-100 w-100">
                <h2 className="display-4 text-center mb-4">Alimentos</h2>
                ...
                <div className="w-100 col">
                    ...
                    <div className='row mb-3'>
                        ...
                        <div className="d-flex align-items-center">
                            <input type="text" className='form-control mr-2' id='searchAlimento' />
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">{(isEditing) ? "Agregar Producto" : "Editar Producto"}</h5>
                            <button type="button" className="btn-close" onClick={handleCloseModal}></button>
                        </div>
                        <div className="modal-body">
                            <div className="form-group mb-2">
                                <label className="mb-2" htmlFor="name">Nombre</label>
                                <input type="text" value={form.name} name='name' className="form-control" onChange={handleChange} placeholder="Ingresa el nombre del producto" />
                            </div>
                            <div className="form-group mb-2 d-none">
                                <input type="text" name="type" className="form-control" value={"Alimento"} onChange={handleChange} />
                            </div>
                            <div className="form-group mb-2">
